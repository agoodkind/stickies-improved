...
public enum BuildConfig {
    ...
    public static let iCloudContainerIdentifier = "H3BMXM4W7H.io.goodkind.stickies-improved"
    public static let sparkleFeedURL =
        Bundle.main
    ...
    public static let marketingVersion =
        Bundle.main
