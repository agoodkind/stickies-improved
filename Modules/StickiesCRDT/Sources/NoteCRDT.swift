...
public final class NoteCRDT {
  ...
  private func bodyObjectID() -> ObjId? {
    if case .Object(let id, .Text)? = currentValue(Key.body, in: ObjId.ROOT) {
      return id
    }
  ...
  private func metaObjectID() -> ObjId? {
    if case .Object(let id, .Map)? = currentValue(Key.meta, in: ObjId.ROOT) {
      return id
    }
  ...
  private func frameObjectID(in meta: ObjId) -> ObjId? {
    if case .Object(let id, .Map)? = currentValue(Key.frame, in: meta) {
      return id
    }
  ...
  private func readFrame(in meta: ObjId) -> NoteFrame? {
    guard case .Object(let frameObject, .Map)? = currentValue(Key.frame, in: meta) else {
      return nil
    }
  ...
  private func readString(_ key: String, in obj: ObjId) -> String? {
    if case .Scalar(.String(let value))? = currentValue(key, in: obj) {
      return value
    }
    return nil
  }
  ...
  private func readDouble(_ key: String, in obj: ObjId) -> Double? {
    if case .Scalar(.F64(let value))? = currentValue(key, in: obj) {
      return value
    }
    return nil
  }
  ...
  private func readBool(_ key: String, in obj: ObjId, default defaultValue: Bool) -> Bool {
    if case .Scalar(.Boolean(let value))? = currentValue(key, in: obj) {
      return value
    }
    return defaultValue
  }
  ...
  private func readDate(_ key: String, in obj: ObjId) -> Date? {
    if case .Scalar(.Timestamp(let value))? = currentValue(key, in: obj) {
      return value
    }
    return nil
  }
